...
NPC | Non Player Character | Pseudo Sentient Computer Controlled Beings
AoE | Area of Effect | Area of effect attacks affect a range rather than a single target
DPS | Damage Per Second | <ul> <li> Damage done per second by a weapon </li> <li> A type of character build that focuses on doing a lot of damage quickly </li> </ul>
...
MP | <ul><li>Magic Points</li> <li>Mana Points</li> </ul> | The attribute that decides if a player can perform a magic move
...
RPG | <ul> <li>Role Playing Game</li> <li> Rocket Propelled Grenade</li></ul>| <ul> <li>A game in which players assume the roles of characters in a fictional setting</li><li>A weapon which launches a rocket</li></ul>
...
RTS | Real Time Strategy | A game which revolves around the player controlling one or more Actors in a game with no turn system
...
TCG | Trading Card Game| A game where players deal cards where cards have unique attribute and the game has different rules than traditional games
P2W | Pay To Win | A game where paying real world cash will benefit a player towards the progression of a game
LoS | Line of Sight | Two points unobstructed by any objects
DOT | Damage Over Time | An attack which damages a player continuously in a set amount of time
MVP | Most Valuable Player |  The player with the most contribution in a team
DLC | DownLoadable Content | The additional content of a game meant to improve or extend gameplay which can be downloaded separately
